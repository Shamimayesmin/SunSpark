			...
			<div className="lg:flex justify-between items-center gap-10">
				<div className="lg:w-1/2">
					...
					<p className="text-[#3B3C4A] text-sm lg:text-xl py-8">
						Level 1 charging provides 4 miles per hour and can prepare your EV
						battery for basic daily use. Level 1 on the EV charging spectrum is
						a regular household outlet (120 volts) coupled with an Electric
