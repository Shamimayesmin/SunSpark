...
import img from "../../../assets/benefit/light.png";
import Image from "next/image";

const Card3 = () => {
  return (
    <div className="bg-[#F9F9FF]">
      <div className="max-w-screen-xl mx-auto lg:py-20 py-10 lg:px-0 px-4 bg-[#FFFFFF]">
        <div className="flex lg:flex-row flex-col-reverse justify-between items-center lg:gap-20 gap-7">
          ...
          <div className="lg:w-1/2 w-full">
            <h1 className="text-[#343F52] lg:text-4xl text-lg font-bold lg:pb-10 pb-5 lg:pr-20">
              Energy Independence: <br /> Take Control of Your Power with
              Solar-PVI
            </h1>
